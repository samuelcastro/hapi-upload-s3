...
var DEFAULT_S3_ENDPOINT = 's3.amazonaws.com'
...
module.exports = function(plugin, options, next) {
   ...
   */
  var ep = new AWS.Endpoint(options.s3Endpoint || DEFAULT_S3_ENDPOINT);
  ...
  var getS3Url = function(fileKey) {
    const host = options.s3Endpoint || DEFAULT_S3_ENDPOINT;
